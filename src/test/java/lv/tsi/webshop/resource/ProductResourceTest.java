...
class ProductResourceTest {
    ...
    @Test
    void getAllComputerProducts() throws Exception {
        mockMvc.perform(get("/product/all/COMPUTERS")).andExpect(status().isOk())
                .andExpect(content()
    ...
    void getProduct() throws Exception {
        mockMvc.perform(get("/product/1")).andExpect(status().isOk())
                .andExpect(content()
                        .string("{\"id\":1,\"name\":\"Lenovo V130-15 Full HD SSD i3\",\"description\":\"Skylake, Intel Core i3, 4 GB DDR4, 128GB SSD\",\"price\":329.0,\"pictureUrl\":\"https://www.1a.lv/images/products/001643/1201801_large.jpg\",\"productCategory\":\"COMPUTERS\"}"));
    }
}